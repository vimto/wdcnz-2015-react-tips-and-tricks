...
Applying changes against a virtual DOM, and then deferring to React's reconcilliation alogrithm means that you don't need to do the heavy lifting of figuring out how to update the DOM efficiently, effectively "double buffering" changes. And it generally means you avoid being chatty with the DOM. 
