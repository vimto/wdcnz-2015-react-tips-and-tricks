...
The way React is architected leads to good perfomance out of the box. And the API offers some simple ways to optimise performance.
...
Note:
This is the source here, and it simply hooks into shouldComponentUpdate and does a shallow comparison of all props and state.

The situation is a little more complicated with nested data structures such as arrays and lists, where a top level comparison like this won't tell you whether the contents of an array or object have changed.
